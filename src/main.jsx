...
function App() {
  ...
  const connectGmail = useCallback((entry) => {
    const oauthWindow = window.open("about:blank", "agent-garden-gmail-oauth", "popup,width=520,height=720");
    if (!oauthWindow) { setNotice("Your browser blocked the Gmail OAuth popup. Allow popups for Agent Garden and try again."); return; }
    oauthWindow.location.href = "/api/gmail/oauth/start";
  }, []);
