  ...
  return (
    <div className="app-shell">
      <aside className={`conversation-rail ${railOpen ? "open" : "closed"}`}>
        ...
        {railOpen && <button className="settings-link" onClick={() => { setConnectorsOpen(true); loadConnectors(); }}><Plug size={17} />Connectors</button>}
