...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      {user?.email?.toLowerCase() === "luybenbrandon35@gmail.com" && <button className="firebase-button" style={{ position: "fixed", right: 24, bottom: 24, zIndex: 20 }} onClick={loadAdminData} disabled={adminLoading}>{adminLoading ? "Loading moderation…" : "Admin moderation"}</button>}
